  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-1">Employees</h2>
        <p className="text-gray-500 mb-6">View all employees in the system</p>
        <div className="bg-white rounded-lg shadow p-6">
          <p className="text-gray-400 text-sm">No employees yet. (API connection coming soon)</p>
        </div>
      </div>
    </div>
  );
